...
enum class DeepLLanguages(val nameId: Int, val value: String) {
    ARABIC(R.string.arabic, "AR"),
    BULGARIAN(R.string.bulgarian, "BG"),
    CHINESE_SIMPLIFIED(R.string.chinese_simplified, "ZH"),
    CHINESE_TRADITIONAL(R.string.chinese_traditional, "ZT"),
    CZECH(R.string.czech, "CS"),
    DANISH(R.string.danish, "DA"),
    ENGLISH_AMERICAN(R.string.english_american, "EN-US"),
    ENGLISH_BRITISH(R.string.english_british, "EN-GB"),
    ...
    LATVIAN(R.string.latvian, "LV"),
    LITHUANIAN(R.string.lithuanian, "LT"),
    NORWEGIAN_BOKMAL(R.string.norwegian_bokmål, "NB"),
    ...
    SLOVENIAN(R.string.slovenian, "SL"),
